...
<div class="container-fluid p-4 mt-5 shadow mx-auto" style="max-width: 1000px;">
    ...
    <div class="card-group justify-content-center">
        <form method="post">
            <h3>Are you sure you want to delete recipe?!</h3>
            <input disabled autofocus class="form-control" value="<?=$recipe->getName()?>" type="text"
                name="class" placeholder="Recipe Name"><br><br>
    ...
    <div style="text-align: center;">
        <h3>That recipe was not found.</h3>
