...
class Image
{
	...
	public function crop($src_image_path,$dest_image_path,$max_width_size = 640, $max_height_size =420)
	{
		if(file_exists($src_image_path)){
			...
			if($src_image){
				...
				$dst_image = imagecreatetruecolor($max_width_size, $max_height_size);
				imagecopyresampled($dst_image, $src_image, 0, 0, $src_x, $src_y, $max_width_size, $max_height_size, $src_w, $src_h);
